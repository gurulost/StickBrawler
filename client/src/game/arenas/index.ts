  ...
  export const ARENA_THEMES: Record<string, ArenaTheme> = {
    ...
    auroraFlux: {
      ...
      openPresentation: {
        ...
        focusBackdropOpacity: 0.04,
        decorationCount: 2,
        decorationScale: 0.82,
        decorationOpacity: 0.2,
        pillarOpacity: 0.34,
        pillarWidthScale: 0.74,
        pillarDepthScale: 0.66,
        platformGlowOpacity: 0.1,
        undersideGlowOpacity: 0.13,
        supportOpacity: 0.26,
    ...
    containment: {
      ...
      containedPresentation: {
        ...
        wallOpacity: 0.32,
        wallTransmission: 0.82,
        railOpacity: 0.08,
        platformHaloOpacity: 0.1,
        spawnPadGlow: 0.2,
      },
      // Old props (from HEAD)
      colors: {
